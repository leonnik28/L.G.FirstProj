    ...
    void ShowPath(int speed)
    {
        if (currentPathExists)
        {
            ...
            while (current != currentPathFrom)
            {
                ...
                current.EnableHighlight(Color.white, false);
                current = current.PathFrom;
            }
        }
        currentPathFrom.EnableHighlight(Color.blue, false);
        currentPathTo.EnableHighlight(Color.red, false);
    }
    ...
    bool Search(HexCell fromCell, HexCell toCell, HexUnit unit)
    {
        ...
        while (searchFrontier.Count > 0)
        {
            ...
            for (HexDirection d = HexDirection.NE; d <= HexDirection.NW; d++)
            {
                ...
                {
                    neighbor.Distance = distance;
                    frontier.Enqueue(neighbor, distance); // èñïîëüçîâàíèå PriorityQueue äëÿ ñîðòèðîâêè ïî distance
                }*/
            }
        }
        return false;
